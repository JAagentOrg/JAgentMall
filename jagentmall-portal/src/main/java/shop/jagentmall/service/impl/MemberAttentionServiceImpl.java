...
import shop.jagentmall.repository.MemberBrandAttentionRepository;
import shop.jagentmall.service.MemberAttentionService;
import shop.jagentmall.service.UmsMemberService;

import java.util.Date;

/**
 * @Title: MemberAttentionServiceImpl
 * @Author: [tianyou]
 * @Date: 2025/2/20
 * @Description: 会员关注品牌管理service实现类
 */
@Service
