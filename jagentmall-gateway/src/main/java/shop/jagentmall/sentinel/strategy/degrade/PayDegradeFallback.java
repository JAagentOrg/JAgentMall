...
/**
 * @Title: PayDegradeFallback
 * @Author: [tianyou]
 * @Date: 2025/2/28
 * @Description: 网站支付熔断降级
 */
@Component
@Slf4j
public class PayDegradeFallback implements FallbackStrategy {
    @Autowired
    ...
    @Override
    public String mark() {
        return fallbackEnum.DEGRADE_PREFIX.getType() + fallbackEnum.DEGRADE_PAY.getType();
    }
    ...
    public Map<String, Object> getResponse(ServerWebExchange exchange) {
        ...
        try {
            ...
            stringRedisTemplate.opsForList().leftPush("pay_retry_queue", jsonRequest);
